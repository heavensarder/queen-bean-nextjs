    ...
    <footer className="bg-black text-white pt-24 pb-8 px-6 md:px-12 flex flex-col items-center z-[80] relative transform-gpu">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-24">
        ...
        <div className="flex flex-col items-center gap-4">
          <h4 className="text-[#86603A] text-xs md:text-sm tracking-[0.2em] font-bold uppercase mb-2">Experience</h4>
        ...
        {/* Column 2: Follow Us */}
        <div className="flex flex-col items-center gap-4">
          <h4 className="text-[#86603A] text-xs md:text-sm tracking-[0.2em] font-bold uppercase mb-2">Follow Us</h4>
        ...
        <div className="flex flex-col items-center gap-4">
          <h4 className="text-[#86603A] text-xs md:text-sm tracking-[0.2em] font-bold uppercase mb-2">Place Your Order</h4>
        ...
        {/* Column 4: Contact Us */}
        <div className="flex flex-col items-center gap-4">
          <h4 className="text-[#86603A] text-xs md:text-sm tracking-[0.2em] font-bold uppercase mb-2">Contact Us</h4>
          <span className="text-sm md:text-base font-brandon font-medium text-white text-center">
            246 South 11th Street<br />
            Philadelphia, PA 19107
          </span>
          <a href="tel:2677614910" className="text-sm md:text-base font-brandon font-medium text-white hover:text-zinc-300 transition-colors">
            (267) 761-4910
          </a>
          <a href="mailto:queenbeanphilly@gmail.com" className="text-sm md:text-base font-brandon font-medium text-white hover:text-zinc-300 transition-colors">
      ...
      {/* Bottom Bar */}
      <div className="w-full max-w-6xl border-t border-zinc-800 pt-8 flex flex-col lg:flex-row justify-between items-center gap-6 text-xs md:text-sm text-zinc-400 font-brandon tracking-wide">
...
function FooterLink({ href, children, isExternal }: { href: string; children: React.ReactNode; isExternal?: boolean }) {
  return (
    <Link 
      ...
      className="text-sm md:text-base font-brandon font-medium text-white hover:text-zinc-300 transition-colors flex items-center gap-2 group"
    >
      {children}
      {isExternal && (
