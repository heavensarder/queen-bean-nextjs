...
export default function MenuClient({ initialCategories }: { initialCategories: MenuCategory[] }) {
  ...
  return (
    <main className="bg-[#F2EFEB] min-h-screen">
      ...
      {/* ── DESKTOP STICKY LEFT SIDEBAR & MENU SECTIONS ── */}
      <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row relative">
        {/* Desktop Sidebar (Fixed Width 260px) */}
        <aside 
          className="hidden lg:block w-[260px] shrink-0 sticky top-[90px] h-[calc(100vh-90px)] overflow-y-auto theme-scrollbar border-r border-zinc-200 bg-[#F2EFEB]"
          data-lenis-prevent="true"
        >
          <div className="p-6 pb-32 flex flex-col gap-2">
            <h3 className="font-anton text-2xl uppercase tracking-widest text-zinc-900 mb-6 px-2">Categories</h3>
            {displayCategories.map((cat) => (
              <a
                ...
                className={`
                  block w-full py-3 px-4 text-left rounded-xl transition-all duration-300
                  ${activeCategory === cat.id
                    ? 'bg-[#86603A] text-white shadow-md font-bold'
                    : 'text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900 font-bold'}
                `}
              >
                <span className="font-brandon text-[13px] uppercase tracking-[0.15em]">{cat.name}</span>
              </a>
            ))}
          </div>
        </aside>
        ...
        {/* Menu Sections (Flex-1) */}
        <div className="flex-1 px-[10px] lg:px-[40px] pb-16 min-w-0">
          ...
          <div className="py-20 text-center">
            ...
            >
              ...
              <div className="mb-10 lg:mb-14 px-4">
                ...
                {category.subtitle && (
                  <p className="font-signature text-xl text-[#86603A] mt-2">
                    {category.subtitle}
                  </p>
                )}
                {/* Notes */}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Details Side */}
        <div className="flex-1 flex flex-col justify-start xl:justify-center px-6 pt-6 pb-0 lg:px-12 lg:pt-12 lg:pb-0 xl:px-16 xl:pt-16 xl:pb-0 overflow-y-auto">
          {/* Category Label */}
          <motion.p
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          <motion.div
            ...
            className="mt-auto pt-6 border-t border-zinc-200 sticky bottom-0 bg-white z-10 pb-6 lg:pb-12 xl:pb-16"
          >
            <div className="flex items-center gap-4">
              ...
              {!item.isAvailable ? (
                ...
                <div className="flex-1 flex flex-row gap-2 sm:gap-3">
                  <div className="bg-zinc-100 border border-zinc-200 rounded-xl px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-center shadow-sm shrink-0">
                    <span className="font-anton text-xl sm:text-2xl text-[#86603A]">
                ...
                <div className="flex-1 flex flex-row gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-black text-white px-2 py-3 sm:px-6 sm:py-4 rounded-xl font-brandon uppercase tracking-wider sm:tracking-widest text-[10px] sm:text-xs font-bold hover:bg-[#86603A] transition-colors shadow-xl flex items-center justify-center group leading-none"
                  >
