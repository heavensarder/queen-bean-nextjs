  ...
  return (
    <section id="locations" className="relative z-[70] w-full bg-[#F2EFEB] p-[10px] md:p-[20px]">
      <div className="flex flex-col md:flex-row border border-black bg-white drop-shadow-2xl overflow-hidden min-h-[60vh] md:min-h-[70vh]">
        ...
        {/* Content Side (Right) */}
        <div className="w-full md:w-1/2 flex flex-col p-8 sm:p-10 md:p-16 lg:p-24 justify-center">
          <h3 className="text-5xl sm:text-6xl text-[#86603A] font-signature mb-2">
            Visit us
          </h3>
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-[5rem] font-anton uppercase tracking-tight leading-[1.0] text-zinc-900 mb-8 md:mb-12">
            OUR LOCATION
          </h2>
          ...
          {!showHours ? (
            ...
            <div className="flex-1 flex flex-col animate-in fade-in duration-500">
              <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-10 gap-4">
                <div>
                  ...
                  <h3 className="text-2xl md:text-3xl font-serif font-bold text-zinc-900">Philadelphia, PA</h3>
                </div>
                <a 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-auto">
                <div>
                  ...
                  <p className="text-sm md:text-base text-zinc-900 leading-relaxed font-medium">
            ...
            <div className="flex-1 flex flex-col animate-in fade-in duration-500">
              <div className="flex gap-6 border-b border-black mb-6">
                {['Store', 'Pickup', 'Delivery'].map(tab => (
                  <button 
                    ...
                    className={`pb-3 text-xs md:text-sm tracking-widest uppercase font-bold relative ${activeTab === tab ? 'text-zinc-900' : 'text-zinc-400 hover:text-zinc-700'}`}
                  >
                    {tab}
                    {activeTab === tab && (
              ...
              <div className="flex-1 flex flex-col gap-3 font-medium text-sm md:text-base">
                {days.map((day, index) => (
          ...
          {/* Bottom Actions */}
          <div className="mt-8 pt-6 border-t border-black flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 sm:gap-6 w-full sm:w-auto">
              ...
              <button className="bg-black text-white px-8 py-3 text-xs tracking-widest font-bold hover:bg-zinc-800 transition-colors ml-auto sm:ml-0">
                ORDER ONLINE
              </button>
            </div>
          </div>
