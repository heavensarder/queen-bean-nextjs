...
export default function FourthSection({ content }: { content?: any }) {
  // Use defaults if content is not provided
  const scriptTitle = content?.scriptTitle || "Our dishes";
  const heading = content?.heading || "SIMPLE. FRESH. HONEST.";
  ...
  return (
    <section className="relative z-50 w-full bg-[#F2EFEB] pt-16 lg:pt-24 pb-0 overflow-hidden">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center px-4 mb-12 lg:mb-20">
        ...
        <h2 
          className="text-4xl md:text-5xl lg:text-6xl xl:text-[5.5rem] font-anton uppercase tracking-normal leading-[1.0] text-zinc-900 mb-6 lg:mb-8"
